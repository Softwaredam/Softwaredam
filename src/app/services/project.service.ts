  ...
  PROJECTS: Project[] = [
    {
      id: 94,
      key: "koop",
      name: "Kennis- en Exploitatiecentrum voor Officiële Overheidspublicaties",
      customer: "KOOP",
      end: "present",
      start: "08/2022",
      ...
      description: [
        "As a Standaard Platform (SP) Cloud specialist, I helped KOOP with a varietey of transformational, modernization, and migration challenges.",
      ],
      roles: ["Cloud Specialist","Technical Lead", "Automation and DevOps Architect"],
      activities: [
